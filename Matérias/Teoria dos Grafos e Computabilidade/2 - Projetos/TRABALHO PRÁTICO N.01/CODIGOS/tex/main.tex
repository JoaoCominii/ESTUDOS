...
\author[João Comini 202X]{
\affil{\textbf{João Comini Cesar de Andrade}~\textcolor{blue}{\faEnvelopeO}~~[~\textbf{Pontifícia Universidade Católica de Minas Gerais}~|~\href{mailto:jccandrade@sga.pucminas.br}{\textbf{\textit{jccandrade@sga.pucminas.br}}}~]}
}
