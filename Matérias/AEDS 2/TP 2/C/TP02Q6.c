...
// Função para ordenar os shows usando Seleção Recursiva
//  Para cada posição indice, ela encontra o menor elemento no restante do array e o troca com o elemento atual.
// A função chama a si mesma até que todo o array seja ordenado.
...
// Função para encontrar o índice do menor elemento no restante do array
// A função encontrarMenor percorre o array a partir do índice fornecido e retorna o índice do menor elemento.
