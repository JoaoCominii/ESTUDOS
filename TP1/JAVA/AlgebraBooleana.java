...
public class AlgebraBooleana {
    ...
    public static char Opera(char string[]) {
        ...
        int posicaoFinal = fechamentoParenteses(string), posicaoInicial = aberturaParenteses(posicaoFinal, string);
        ...
        while (posicaoFinal != posicaoInicial) {
            ...
            posicaoFinal = fechamentoParenteses(string);
            posicaoInicial = aberturaParenteses(posicaoFinal, string);

        }

        char resultado = verificaResultado(string);
        return resultado;
    }
